...
- "Biocultural conflicts: understanding complex interconnections between a 
  traditional ceremony and threatened carnivores in north Kenya"

- " The traditional ecological knowledge conundrum"

Add classic hysteresis type plot here

In parallel to this social-ecological approach, quantitative sociologists have explored the conditions under which opinions and culture form and persist, and how these dyamics are influenced by social learning(Castellano et al. 2009 ref!)..  Flache et al. [ref!, JASSS] identify three different end states in a population for opinion: consensus, clustering, and bi-polorisation; these are influenced by the nature of social interaction and learning.  Limited enagaemet between these different research threads.  LEarning effected by geog distance, cognitive proximity, etc.


Dimension of proximity: cognitive, geographic, spocial, organisational, institutional
https://link.springer.com/article/10.1007/s11625-024-01463-z#Sec4
https://www.tandfonline.com/doi/abs/10.1080/0034340052000320887


Lyver et al. [@lyverBioculturalHysteresisInhibits2019] describe a conceptual model of how social-ecological systems can suffer 'biocultural hysteresis'. In their model, following the erosion of a KBP complex,  positive feedbacks act to maintain a new state potentially even after the mechanisms underpinning the loss are removed. In such settings, the restoration of the biological resource may be insufficient to restore the knowledge associated with it  Hysteresis implies that the loss of KBP persists even if access to the resource is reinstated. However, it is not clear under which conditions such hysteresis in KBP might occur and how they might be reinstated. 
